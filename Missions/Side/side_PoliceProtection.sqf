...
{
    _x setMarkerPos _smPos;
} forEach ["sideMarker", "sideCircle"];

switch (_BluforFaction) do{
	case "FIA": {
        private _markerText = "Side Mission: Protect FIA Forces";
        "sideMarker" setMarkerText _markerText;
        [
            west,
            "policeTask",
            [
                "Undercover agents have provided Intel that hostile forces are planning to attack a squad of allied FIA forces. We have the approximate location the the police force. Get over there and protect the police.",
                _markerText,
                "sideCircle"
            ],
	...
	case "Gendarmerie": {
        private _markerText = "Side Mission: Protect U.N. Police Forces";
        "sideMarker" setMarkerText _markerText;
        [
            west,
            "policeTask",
            [
                "Undercover agents have provided Intel that hostile forces are planning to attack a U.N. Police Force. We have the approximate location the the police force. Get over there and protect the police.",
                _markerText,
                "sideCircle"
            ],
            (getMarkerPos "sideCircle"),
