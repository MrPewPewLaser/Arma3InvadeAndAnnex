...
private _mortarObjs = [
    ["B_Mortar_01_F",[-0.119873,1.18896,-0.222783],0],
    ["B_Mortar_01_F",[-0.935547,-0.328125,-0.222783],240],
    ["B_Mortar_01_F",[0.925537,-0.265137,-0.222783],120]
];
...

{
    ...
    _mortar removeMagazinesTurret ["8Rnd_82mm_Mo_Flare_white", [0]];
    _mortar removeMagazinesTurret ["8Rnd_82mm_Mo_Smoke_white", [0]];

    _mortar addEventHandler ["Fired", {
        params ["_unit", "_weapon", "_muzzle", "_mode", "_ammo", "_magazine", "_projectile", "_gunner"];

        private _magsRemaining = ({_x == "8Rnd_82mm_Mo_shells"} count (_unit magazinesTurret [[0], false]));
        private _ammoLeft = (_gunner ammo (currentMuzzle _gunner));

        if (_magsRemaining < 4) then {
            _unit addMagazineTurret ["8Rnd_82mm_Mo_shells", [0]];
        };
    }];
} forEach _mortarObjs;
...
private _mortarGroup = (createGroup _side);
...
"radioMarker" setMarkerText "Sub-Objective: Mortar Team";
