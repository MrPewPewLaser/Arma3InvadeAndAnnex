...
private _aaaForts = [
    [
        ...
        [
            ["O_APC_Tracked_02_AA_F",[4.62231,0.397812,-0.222783],180.024],
            ["O_APC_Tracked_02_AA_F",[-4.78149,0.232162,-0.222783],0]
        ]
    ],
    ...
    [
        ...
        [
            ["O_APC_Tracked_02_AA_F",[-8.15723,-4.27762,-0.222783],239.982],
            ["O_APC_Tracked_02_AA_F",[0.215088,9.17184,-0.222783],0],
            ["O_APC_Tracked_02_AA_F",[7.85083,-4.51697,-0.222783],120.042]
        ]
    ]
];
...

{
    ...
    _aaa removeMagazinesTurret ["SmokeLauncherMag", [0,0]];
    _aaa removeWeaponTurret ["SmokeLauncher", [0,0]];

    _aaa addMagazineTurret ["680Rnd_35mm_AA_shells_Tracer_Green", [0]];
...
private _aaaGroup = (createGroup _side);
...
for [{_i = 0}, {_i < 4}, {_i = (_i + 1)}] do {
    ...
    private _grp = [_units, _randomPos, nil, _side] call AW_fnc_spawnAIGroup;
...
} forEach ["radioMarker", "radioCircle"];

"radioMarker" setMarkerText "Sub-Objective: AAA Fortification";
