...

{
    ...
    if (_x isKindOf "O_MBT_02_arty_F") then {
        _x removeMagazinesTurret ["2Rnd_155mm_Mo_guided_O", [0]];
        _x removeMagazinesTurret ["6Rnd_155mm_Mo_mine_O", [0]];
        _x removeMagazinesTurret ["2Rnd_155mm_Mo_Cluster_O", [0]];
        _x removeMagazinesTurret ["6Rnd_155mm_Mo_smoke_O", [0]];
        _x removeMagazinesTurret ["4Rnd_155mm_Mo_LG_O", [0]];
        _x removeMagazinesTurret ["6Rnd_155mm_Mo_AT_mine_O", [0]];

        _x removeMagazinesTurret ["SmokeLauncherMag", [0,0]];

        _x addMagazineTurret ["32Rnd_155mm_Mo_shells_O", [0]];
        _x addMagazineTurret ["32Rnd_155mm_Mo_shells_O", [0]];
        _x addMagazineTurret ["32Rnd_155mm_Mo_shells_O", [0]];
        _x addMagazineTurret ["32Rnd_155mm_Mo_shells_O", [0]];
        _x addMagazineTurret ["32Rnd_155mm_Mo_shells_O", [0]];

        _x addMagazineTurret ["200Rnd_127x99_mag_Tracer_Green", [0,0]];
        _x addMagazineTurret ["200Rnd_127x99_mag_Tracer_Green", [0,0]];

        _x addMagazineTurret ["96Rnd_40mm_G_belt", [0,0]];
    };
