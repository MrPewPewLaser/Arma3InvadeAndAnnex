...
private _mlrsObj = [
    ["I_Truck_02_MRL_F",[17.1416,-13.5228,-3.8754],134.986],
    ["I_Truck_02_MRL_F",[17.2964,14.9695,-3.8754],43.9696]
];
...
private _mlrsSkins = ["GreenHex", "Inped", "Opfor"];
...
//Spawn Ammotruck
private _ammoTruck = [_origin, ["I_E_Truck_02_Ammo_F", [-13.375,-15.875,-3.8754],233.382], _rndDir] call AW_fnc_spawnRelative;
_ammoTruck allowDamage false;
_ammoTruck enableSimulationGlobal false;
_ammoTruck lock true;
_ammoTruck setFuel 0;
[_ammoTruck, (selectRandom _mlrsSkins)] call BIS_fnc_initVehicle;
...
// Spawn MLRSs
private _mlrsSkin = (selectRandom _mlrsSkins);
private _mlrsGroup = (createGroup east);

{
    private _mlrs = [_origin, _x, _rndDir] call AW_fnc_spawnRelative;

    [_mlrs, _mlrsSkin] call BIS_fnc_initVehicle;
...
"priorityMarker" setMarkerText "Priority Target: Rocket Artillery";
