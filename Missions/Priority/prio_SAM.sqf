...
private _samSiteGroup = createGroup east;
_samSiteGroup setGroupIdGlobal ["PRIO-SAM_Lanchers"];
...
private _hqGuardsGroup = (createGroup east);
...
"priorityMarker" setMarkerText "Priority Target: SAM Site";
