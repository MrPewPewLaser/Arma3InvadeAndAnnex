...
switch (_rewardId) do {
    ...
    case 502: {
        ...
        private _vehicleSkin = (selectRandom ["Sand", "Olive"]);
        private _aaaSkin = _vehicleSkin;

        if (_vehicleSkin == "Olive") then {
            _aaaSkin = "Green";
        };
    ...
    case 503: {
        ...
        private _vehicleSkin = _vehicle getVariable ["InA_VehicleSkin", "Sand"];

        private _aaSkin = "Sand";

        if (_vehicleSkin in ["Guerilla_01", "Guerilla_03"]) then {
            _aaSkin = "Green";
        };
